...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    {/*always open and close EventListener in react */}
  ...
  return (
    ...
    <NavButton title="Chat" dotColor="#03C9D7" customFunc={() => handleClick('cart')} color="blue" icon={<BsChatLeft />} />
      ...
      content="profile" position="BottomCenter" >
        ...
        onClick={() => handleClick ('userProfile')} >
          ...
          <p>
            ...
            <span className="gray-400 font-bold ml-2 text-14" >John</span>
          </p>
